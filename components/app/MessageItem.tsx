...
export function MessageItem({
    ...
    return (
      <div className="mb-6 min-w-0">
        ...
        <div className="flex items-start gap-3 [font-family:var(--font-mono)] text-[14px]">
          ...
          <span className="min-w-0 break-words text-[var(--text-primary)] [overflow-wrap:anywhere]">{message.text}</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="mb-7 min-w-0">
      ...
      <div className="min-w-0 break-words text-[14px] leading-[1.6] text-[var(--text-secondary)] [overflow-wrap:anywhere]">
